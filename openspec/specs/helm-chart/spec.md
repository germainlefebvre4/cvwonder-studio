...
This capability provides a Helm v3 chart for deploying CVWonder Studio to Kubernetes. The chart follows Prometheus chart formalism, supports PostgreSQL as a sub-chart dependency, and provides configuration options for all major features including Gotenberg PDF export, persistent storage, ingress, and horizontal scaling.
