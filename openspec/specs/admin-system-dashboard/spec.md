# Spec: admin-system-dashboard

## Purpose

Defines the admin API surface for system-level visibility: an aggregate dashboard with session and theme statistics plus binary/storage info, and a health check endpoint that reports database connectivity and binary availability.
