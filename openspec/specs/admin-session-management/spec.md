# Spec: admin-session-management

## Purpose

Defines the admin API surface for inspecting and managing user sessions. Admins can list sessions with pagination and search, force-expire individual sessions, permanently delete sessions, and bulk-purge all expired sessions.
