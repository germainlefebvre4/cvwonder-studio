# Spec: admin-theme-management

## Purpose

Defines the admin API surface for managing themes: listing installed themes, browsing the curated catalog, discovering available versions, installing or updating themes from GitHub, checking for updates, and soft-deleting runtime themes. Builtin themes are protected from deletion.
